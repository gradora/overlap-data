...
- `data/f1/fia/<season>_<round>.json` — файл раунда НАКАПЛИВАЕТСЯ: прогон
  ...
  final → provisional. Удаление решения — только по прогону, прочитавшему ВСЕ
  документы списка без осечек (иначе сетевой сбой читался бы как отзыв
  документа: Zandvoort-2026 R12 скакал 11 → 1 → 11 → 2 прямо в уик-энд).
