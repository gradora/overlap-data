...
test("длинное окно — только у продьюсеров решений стюардов из белого списка", () => {
  ...
  assert.deepEqual(short.sort(), [
    "f1.ts", "f1beasts.ts", "f1milestones.ts",
    // Пострейс-канал питстопов: пропуск уже собранного события. Окно
    // РЕЗУЛЬТАТНОЕ и другим быть не может — топики статики дописываются
    // вместе с классификацией, а не с решениями стюардов.
    "f1pitstops.ts",
    "f1weather.ts",
