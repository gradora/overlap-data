...
test("блокеры сплита названы поимённо", () => {
  ...
  //
  // 11–12.09.2026 список стал ПУСТЫМ: этап 5.2 снял последние фолбэки клиента
  // на кухню jolpica (расписание, зачёты, спринты, Last Event, сезон N+1), а
  // вместе с ними — транспорт и baseURL сервиса, так что обращение к чужому
  // API физически невозможно. Пустой список здесь означает ровно одно: кухня
  // больше не держит сроки репо-сплита. Проверка оставлена СТРОГОЙ (не «пусто
  // или что угодно»), чтобы новый клиентский читатель кухни снова стал виден.
