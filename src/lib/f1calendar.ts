...
/// Расхождение → warning, побеждает ВСТРОЕННОЕ (приоритет фазы 2 не
/// перещёлкиваем до обкатки). Карта недоступна → null: ref nullable, рядом
/// лежит display-строка venue, экран деградирует до сегодняшнего поведения.
