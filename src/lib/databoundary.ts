...
export const DATA_FAMILIES: DataFamily[] = [
  ...
  },
  {
    ...
    note: "HTML fiawec. Клиентских читателей нет (каскад удалён шагом 3c), но " +
      "это ВХОД СБОРКИ: 8 прямых чтений диска в 6 модулях обслуживают 5 " +
      "продьюсеров — wec, weclive, wecfia, wechighlights и wecwinners — через " +
      "3 библиотеки: wecsnapshot, wecevents, alkamelwec. Счёт уточнён 31.08.2026 " +
      "аудитом: прежняя запись называла weclive прямым читателем (он косвенный) " +
      "и пропускала alkamelwec и wecwinners — переезд по той карте дал бы " +
      "молчаливый отвал победителей WEC. Копия уже лежит в приватном репо; " +
      "удалить отсюда можно только вместе с переносом или заменой входа.",
  },
