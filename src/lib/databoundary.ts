...
export const DATA_FAMILIES: DataFamily[] = [
  ...
  },
  {
    ...
    note: "С 01.09.2026 у клиента в основном ФОЛБЭК: протоколы+стинты — блок " +
      "protocols файла события, рейс-контрол — f1/racecontrol. Расписание " +
      "Day-сессий тестов и оверлей-этапов (Б1) — блок schedule файла события " +
      "с 08.09; клиентский читатель — PR 0.6.6, до него loadSessions — " +
      "основной путь. Прямыми остались погодная выгрузка производителя и " +
      "цепочки для событий без файла (архив до 2023).",
  },
  {
