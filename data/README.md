...
| кухня | `wec/fiawec` (24 МБ) | нет, но читают ШЕСТЬ продьюсеров WEC — переезд только вместе со сборкой |
...
`wec/fiawec` — отдельный случай: клиент его не читает (каскад удалён шагом 3c),
но это ВХОД СБОРКИ для шести продьюсеров. Унести его — не скопировать, а
перенести сборку WEC; иначе публичный воркфлоу перестанет собирать WEC.
